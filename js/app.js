...
document.querySelector('.btn-roll').addEventListener('click', function () {
	if(gamePlaying) {
		...
		//C:\Users\Ganesh Kollati\Desktop\Git-Uploads\Dom_Pig_Game\image\dice-1.png
		...
		if(dice !== 1 && dice2 !== 1) {
			...
			if(dice == 6 || dice2 == 6){
				...
				if(dicePreviousSix == true){
					var listSixs = document.querySelectorAll("[src='/image/dice-6.png']");
...
function nextPlayer(theTimeout) {
	...
	var listOnes = document.querySelectorAll("[src='/image/dice-1.jpg']");
